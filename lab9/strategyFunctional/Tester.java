...
public class Tester
{    
    SortingStrategy2 quickSort2 = (int a[], int lo0, int hi0) -> {
        int lo = lo0;
        int hi = hi0;
        if (lo >= hi) {
            return;
         ...
         *  pivot.
         */
        this.quickSort2.sort(a, lo0, lo-1);
        this.quickSort2.sort(a, hi+1, hi0);
    };

    SortingStrategy quickSort = (int a[]) -> {
        this.quickSort2.sort(a, 0, a.length-1);
    };
    ...
    public static void main( String[] args)
    {
        ...
        DataSet dataset = new DataSet(tester.quickSort) ; // defaults to BubbleSort
        dataset.display();
        dataset.doSort();
        dataset.display();
        dataset.resetData();
